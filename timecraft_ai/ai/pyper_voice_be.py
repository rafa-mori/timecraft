...
try:
    ...
    logger.warning("PiperVoice not available. Fallback will be used.")
...
class IPyperVoice:
    ...
    def initialize_backends(self) -> None:
        ...
        try:
            ...
            self.piper_instance = PiperVoice.load(model_path)
        ...
        try:
            ...
            try:
                ...
                with wave.open(temp_path, 'wb') as wav_file:
                    # PiperVoice will set the correct parameters
                    self.piper_instance.synthesize(text, wav_file)
